package com.restwithspring.unitTests.mapper;
...
import com.restwithspring.unitTests.mocks.MockPerson;
...
public class MapperConverterTest {
    ...
    public void parseVOToEntityTest() {
        PersonEntity output = ModelMapperConverter.parseObject(inputObject.mockVO(), PersonEntity.class);
        assertEquals(Long.valueOf(0L), output.getId());
        assertEquals("First Name Test0", output.getFirstName());
        assertEquals("Last Name Test0", output.getLastName());
        assertEquals("Addres Test0", output.getAddress());
    ...
    public void parserVOListToEntityListTest() {
        List<PersonEntity> outputList = ModelMapperConverter.parseListObjects(inputObject.mockVOList(), PersonEntity.class);
